...
public interface StrigerListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link StrigerParser#else_part}.
	 * @param ctx the parse tree
	 */
	void enterElse_part(StrigerParser.Else_partContext ctx);
	/**
	 * Exit a parse tree produced by {@link StrigerParser#else_part}.
	 * @param ctx the parse tree
	 */
	void exitElse_part(StrigerParser.Else_partContext ctx);
	/**
