...
public class StrigerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "T__36", "T__37", "Variable_name", "Str", 
			"Int", "WHITESPACE", "COMMENT", "LINE_COMMENT"
		};
	}
	...
	public StrigerLexer(CharStream input) {
		super(input);
